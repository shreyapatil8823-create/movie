...
void main() {
  runApp(NextSceneApp());//Entry point of the Flutter app; starts rendering UI.
}

class NextSceneApp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {//Root widget that defines app theme, routing, and structure
    return MaterialApp(//Root widget that defines app theme, routing, and structure.
      debugShowCheckedModeBanner: false,
      title: 'NextScene',//pplies dark theme across the app.
      theme: ThemeData.dark(),//Sets initial screen shown when app launches.
      home: SplashScreen(),
    );
  }
}
...
class SplashScreen extends StatefulWidget {
  @override
  _SplashScreenState createState() => _SplashScreenState();//Stateful widget used because animations require state.
}
...
class _SplashScreenState extends State<SplashScreen>
  ...
  void initState() {
    ...
    _controller = AnimationController(
      vsync: this,
      duration: Duration(seconds: 2),//Initializes animation controller with duration.
    );
    ...
    Future.delayed(Duration(seconds: 3), () {//Starts animation.
      Navigator.pushReplacement(
        context,
        MaterialPageRoute<void>(builder: (_) => LoginPage()),//Delays navigation to login screen by 3 seconds.
      );
    });
  }
...
// ---------------- LOGIN PAGE ----------------
class LoginPage extends StatefulWidget {//Used to validate form inputs.
  @override
  _LoginPageState createState() => _LoginPageState();
}

class _LoginPageState extends State<LoginPage> {//Controls and retrieves email input.
  final _formKey = GlobalKey<FormState>();

  final TextEditingController emailController = TextEditingController();
  final TextEditingController passwordController = TextEditingController();

  void login() {//Validates form before login.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(//Displays background movie poster image.
        children: [
          SizedBox.expand(
            child: Image.network(
